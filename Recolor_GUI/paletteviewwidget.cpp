...
void PaletteViewWidget::paintGL()
{
    ...
    vector<cv::Vec3d> const& ori_palette = data->GetOriginalPalette();
    vector<cv::Vec3d> const& cur_palette = data->GetChangedPalette();
